        ...
        move |i: &mut &str| {
            ...
            .postfix(
                delimited(
                    ...
                    alt((
                        dispatch! {any;
                            '!' => not('=').value(Postfix(19, (|_: &mut _, a| Ok(Expr::Fac(Box::new(a)))) as _)),
                            '?' => empty.value(Postfix(3, (|i: &mut &str, cond| {
                            ...
                            '[' => empty.value(Postfix(20, (|i: &mut &str, a| {
                        ...
                        dispatch! {take(2usize);
                            "++" => empty.value(Postfix(20, (|_: &mut _, a| Ok(Expr::PostIncr(Box::new(a)))) as _)),
                            "--" => empty.value(Postfix(20, (|_: &mut _, a| Ok(Expr::PostDecr(Box::new(a)))) as _)),
                            _ => fail,
                        },
                    )),
                    multispace0,
